...
///////////////////////////////////////////////////////////////////////////////////
  ...
  async function fetchStoresDataReal(query = '') {
    const res = await fetch(`http://백엔드서버주소/api/search?q=${encodeURIComponent(query)}`, {
      method: 'GET',
      headers: {
  ...
  async function renderAllStoreCards() {
    ...
    try {
      ...
      storeListContainer.innerHTML = '<p style="text-align:center; color:red">가게 정보를 불러오는 데 실패했습니다.</p>';
    }
  }
